...
require_once("server/eject_out.php");
?>
<!-- DELIMITED WITH SERVER EXPLOITATION-------------------------------------------------------------------------------------------------------------------------->
<!DOCTYPE html>
<html lang="en">
  <head>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index1.php" class="site_title"><i class="fa fa-paw"></i> <span>Kaysoft</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li <?php if (isset($_SESSION['administrateur'])) {echo $_SESSION['administrateur'];} ?>><a><i class="fa fa-desktop"></i> UI Elements <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <li <?php if (isset($_SESSION['administrateur'])) {echo $_SESSION['administrateur'];} ?>><a><i class="fa fa-table"></i> Tables <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="tables.php">Tables</a></li>
                      <li><a href="tables_dynamic.php">Table Dynamic</a></li>
                    </ul>
                  </li>
                  <li <?php if (isset($_SESSION['administrateur'])) {echo $_SESSION['administrateur'];} ?>><a><i class="fa fa-bar-chart-o"></i> Data Presentation <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <li <?php if (isset($_SESSION['administrateur'])) {echo $_SESSION['administrateur'];} ?>><a><i class="fa fa-clone"></i>Layouts <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
              ...
              <div <?php if (isset($_SESSION['administrateur'])) {echo $_SESSION['administrateur'];} ?> class="menu_section">
                <h3>Live On</h3>
                <ul class="nav side-menu">
                  <li <?php if (isset($_SESSION['administrateur'])) {echo $_SESSION['administrateur'];} ?> ><a><i class="fa fa-user"></i> PROFIL <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="e_commerce.php">E-commerce</a></li>
                      <li><a href="projects.php">Projects</a></li>
                      <li><a href="project_detail.php">Project Detail</a></li>
                      <li><a href="collaborateur.php">Collaborateurs</a></li>
                      <li><a href="utilisateur.php">Utilisateurs</a></li>
                      <li><a href="profile.php">Profile</a></li>
                    </ul>
                  </li>
                  <li <?php if (isset($_SESSION['administrateur'])) {echo $_SESSION['administrateur'];} ?>><a><i class="fa fa-windows"></i> Extras <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <li <?php if (isset($_SESSION['administrateur'])) {echo $_SESSION['administrateur'];} ?>><a><i class="fa fa-sitemap"></i> Multilevel Menu <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <li <?php if (isset($_SESSION['administrateur'])) {echo $_SESSION['administrateur'];} ?>><a href="javascript:void(0)"><i class="fa fa-laptop"></i> Landing Page <span class="label label-success pull-right">Coming Soon</span></a></li>
                </ul>
              </div>
                ...
                <div class="x_content">
                  <div class="dashboard-widget-content">
                    <ul class="quick-list">
                      ...
                      <li><i class="fa fa-area-chart"></i><a href="server/logout.php">Logout</a>
                      </li>
                    </ul>
